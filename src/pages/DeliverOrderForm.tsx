    ...
    return (
        <div className='pb-72'>
            <Grid container spacing={2}>
                <Grid item xs={2} sm={3} lg={2} md={2}><p></p></Grid>
                <Grid item xs={7} sm={3} lg={7} md={7} className='border mt-20 pt-5 pr-5'>
...
<button type="submit" className="p-2 w-28 font-bold rounded-md bg-blue-800 ">
                                    Order
</button>
</div>
</form>
                ...
                <Grid item xs={2} sm={2} lg={3} md={2}><p></p></Grid>
            </Grid>
        </div>
    )
}
